...
template <int DisplacementDim>
typename SolidMinkley<DisplacementDim>::KelvinVector plasticFlowDeviatoricPart(
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    OnePlusGamma_pTheta const& one_gt, double const sqrtPhi,
    typename SolidMinkley<DisplacementDim>::KelvinVector const& dtheta_dsigma,
...
template <int DisplacementDim>
typename SolidMinkley<DisplacementDim>::ResidualVectorType
    ...
    MaterialProperties const& mp)
{
    ...
    typename SolidMinkley<DisplacementDim>::ResidualVectorType residual;
...
template <int DisplacementDim>
typename SolidMinkley<DisplacementDim>::JacobianMatrix calculatePlasticJacobian(
    double const dt,
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    double const lambda,
    MaterialProperties const& mp)
{
    ...
    typename SolidMinkley<DisplacementDim>::JacobianMatrix jacobian =
        SolidMinkley<DisplacementDim>::JacobianMatrix::Zero();
...
template <int DisplacementDim>
typename SolidMinkley<DisplacementDim>::KelvinVector predict_sigma(
    double const G, double const K,
    typename SolidMinkley<DisplacementDim>::KelvinVector const& sigma_prev,
    typename SolidMinkley<DisplacementDim>::KelvinVector const& eps,
    typename SolidMinkley<DisplacementDim>::KelvinVector const& eps_prev,
    double const eps_V)
{
    static int const KelvinVectorSize =
        ProcessLib::KelvinVectorDimensions<DisplacementDim>::value;
    ...
    typename SolidMinkley<DisplacementDim>::KelvinVector const sigma_D_prev =
        P_dev * sigma_prev / G;
    // dimensionless deviatoric stress
    typename SolidMinkley<DisplacementDim>::KelvinVector const sigma_D =
...
template <int DisplacementDim>
boost::optional<std::tuple<typename SolidMinkley<DisplacementDim>::KelvinVector,
                           std::unique_ptr<typename MechanicsBase<
                               DisplacementDim>::MaterialStateVariables>,
                           typename SolidMinkley<DisplacementDim>::KelvinMatrix>>
SolidMinkley<DisplacementDim>::integrateStress(
    double const t,
    ProcessLib::SpatialPosition const& x,
    double const dt,
